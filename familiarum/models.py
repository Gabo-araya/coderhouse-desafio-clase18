...
class Persona(models.Model):
    ...
    observaciones = models.TextField(null=True, blank=True, verbose_name='Biografía')
    imagen =  models.CharField(max_length=250, null=True, blank=True, default='', verbose_name='Imagen')
    ...
    class Meta:
        ''' class Meta: Define el nombre singular y plural, y el ordenamiento de los elementos. '''
